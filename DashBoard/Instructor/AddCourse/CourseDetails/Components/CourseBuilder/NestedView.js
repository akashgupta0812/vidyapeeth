...
import { setCourse } from "../../../../../../redux/slices/courseReducer"
import ConfirmationModal from "../../../../../ConfirmationalModal"
import SubSectionModal from "./SubSectionModal"

export default function NestedView({ handleChangeEditSectionName }) {
    console.log("on clicking i am called");
  const { course } = useSelector((state) => state.course)
  const { token } = useSelector((state) => state.auth)
  const dispatch = useDispatch()
  console.log("course ka courseName ",course.CourseContent);
  console.log("new se ",course);
  ...
  const handleDeleteSubSection = async (subSectionId, sectionId) => {
    ...
    if (result) {
      ...
      console.log("updated cpoure   ",updatedCourse);
